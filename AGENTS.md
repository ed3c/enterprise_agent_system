...
The public mechanisms may be integrated/closed at their bounded objectives. Program #6 and Local Handoff #14 remain open because the source/PDF real-problem denominator is not closed.
...
3. Superseded/historical candidates do not merge; close or retain them only as historical evidence.
...
7. Program #6 and #14 stay open until real closure, not merely publication closure.
