...
| `validate_convergence_snapshot` | exact-owner/evidence P5 convergence candidate | owner substitution, stale EAS-A subject/receipt/authority, missing denominator lanes, false Git ancestry, stronger-lane credit, false vertical-canary execution |
...
EAS-X deliberately keeps `A2R_RUNTIME_CONTRACT` (`runtime-env`) separate from `A2_SANDBOX_STEERING` (`agent-shield-monorepo`). EAS-A issue #10 is now bound to PR #68 exact subject `250717db1cad584d50890c0d851153fa2cd755e8` / tree `fbf6a75b6e89e906f227110dc5a61e4355b8a891`, hosted verification `32295871632`, and Shadow `4976213414`. Its authority remains `ADVISORY_ONLY`; Google connectivity/write and canonical-state mutation remain unperformed/forbidden. It is a process dependency, not an X Git parent or owner runtime.
